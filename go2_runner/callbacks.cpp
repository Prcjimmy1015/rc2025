...
void rangeCB(const void *m)
{
    ...
    if (rx > 0.01 && rx < 10.0)
    {
        ...
        if (!g_have_front)
        {
            ...
            ob_x_f = ob_x_f * (1.0 - kRangeEmaAlpha) + rx * kRangeEmaAlpha;
    }
    if (ry > 0.01 && ry < 10.0)
    {
        ob_y = ry;
        if (!g_have_left)
        {
            ...
            ob_y_f = ob_y_f * (1.0 - kRangeEmaAlpha) + ry * kRangeEmaAlpha;
    }
    if (rz > 0.01 && rz < 10.0)
    {
        ob_z = rz;
        if (!g_have_right)
        {
            ...
            ob_z_f = ob_z_f * (1.0 - kRangeEmaAlpha) + rz * kRangeEmaAlpha;
    }
